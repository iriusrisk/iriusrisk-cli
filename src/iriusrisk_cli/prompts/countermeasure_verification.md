# Countermeasure Implementation Verification - AI Assistant Guide
...
Use `countermeasure_verification` when:
...
- Just want to see what countermeasures exist (use threats_and_countermeasures instead)
- Comparing versions (use compare_versions instead)
...
Use this tool when reviewing PRs that claim to implement security controls, enabling fast, automated verification of control implementation before human security review.
