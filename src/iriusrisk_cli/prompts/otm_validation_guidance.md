# OTM Validation Guidance for AI Assistants
...
**This tool provides detailed validation instructions and examples.**
...
The backend now validates OTM files against JSON schema before import. But schema validation does NOT check:
