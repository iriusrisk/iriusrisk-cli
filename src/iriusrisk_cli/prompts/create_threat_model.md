...
**🚨 MANDATORY: sync() has already downloaded `.iriusrisk/current-threat-model.otm` if project exists**
...
- ✅ **YOU ARE UPDATING** - use IDENTICAL merge logic as multi-repo workflow
- ✅ **READ and parse the entire file** to understand:
...
- ✅ Your job is to ADD components, not replace
- ✅ Preserve all existing layout information
- ✅ Calculate positions for new components that fit with existing layout
- ✅ Use the SAME merge algorithm as multi-repo contributions
